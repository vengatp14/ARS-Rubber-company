jQuery(document).ready(function( $ ) {
  ...
  $(window).scroll(function() {
    if ($(this).scrollTop() > 100) {
      ...
      // $('#header #top-links').slideUp();
      // $('#mobile-nav-toggle i').css({color:'#3c0293'});
    } else {
      $('#header').removeClass('header-scrolled');
      // $('#header #top-links').slideDown();
...
var images=new Array('img/intro-bg.jpg','img/venue-info-bg.jpg');
var currimg = 0;
